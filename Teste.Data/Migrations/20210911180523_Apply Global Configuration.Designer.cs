...
namespace Teste.Data.Migrations
{
    ...
    [Migration("20210911180523_Apply Global Configuration")]
            ...
            modelBuilder.Entity("Teste.Domain.Entities.Client", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 11, 15, 5, 22, 619, DateTimeKind.Local).AddTicks(5341));
            ...
            modelBuilder.Entity("Teste.Domain.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 11, 15, 5, 22, 620, DateTimeKind.Local).AddTicks(5245));
