...
namespace Teste.Data.Migrations
{
    ...
    [Migration("20210915164126_Creating Fields")]
    partial class CreatingFields
    {
            ...
            modelBuilder.Entity("Teste.Domain.Entities.Client", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 15, 13, 41, 26, 457, DateTimeKind.Local).AddTicks(5538));
            ...
            modelBuilder.Entity("Teste.Domain.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 15, 13, 41, 26, 458, DateTimeKind.Local).AddTicks(6097));
